...
x402 represents more than a payment protocol - it's infrastructure for an autonomous digital economy where software agents can participate as economic actors.

It was a surprise that a critical section such as payments - is being tried to be dealt with AI Agents. 
